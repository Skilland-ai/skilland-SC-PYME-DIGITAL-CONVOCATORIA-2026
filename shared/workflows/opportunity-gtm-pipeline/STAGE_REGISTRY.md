...
| `07_qualification` | `eligibility-and-commercial-qualifier` | `implemented` | offer brief + context pack | `07_qualification/eligibility_commercial_qualification_matrix.md` | user validation required | `08_icp_segmentation` | untested, run/eval todavia pendientes |
| `08_icp_segmentation` | `icp-and-segmentation` | `implemented` | qualification matrix + offer | `08_icp/icp_segmentation_brief.md` | user validation required | `09_qa_gate_3_readiness` | untested, run/eval todavia pendientes |
