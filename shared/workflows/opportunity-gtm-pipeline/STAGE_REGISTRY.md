...
| `06_qa_gate_2_offer` | `compliance-qa-reviewer` | `planned` | offer brief + constraints | `06_qa_gate_2/qa_offer_report.md` | gate 2 | `07_qualification` | usara esta skill cuando existan offer/context upstream; untested |
